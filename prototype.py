...
if 'host' not in cfg_db.keys():
    raise KeyError('Could not find the host of the influx db. Please validate the config file.')
elif 'user' not in cfg_db.keys():
    raise KeyError('Could not find the user of the influx db. Please validate the config file.')
elif 'password' not in cfg_db.keys():
    raise KeyError('Could not find the password of the influx db. Please validate the config file.')
elif 'database' not in cfg_db.keys():
    raise KeyError('Could not find the database of the influx db. Please validate the config file.')
